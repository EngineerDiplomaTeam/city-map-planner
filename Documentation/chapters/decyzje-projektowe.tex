...
\subsubsection{Microsoft Azure Cloud}
...
\subsubsection{Oracle Cloud Platform}
...
\section{Przechowywanie kodu oraz potok ciągłego wdrożenia}
\label{sec:przechowywanie-kodu-oraz-potok-ciagego-wdrozenia}
