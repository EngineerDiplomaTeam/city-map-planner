...
\paragraph{Progresywna Aplikacja Internetowa} (Progressive~Web~Apps)~to~aplikacje uruchamiane~jak~zwykłe strony internetowe,~ale~zapewniające doświadczenie podobne~do~natywnych aplikacji mobilnych~lub~desktopowych.\cite{pwa-book}
...
\indent \paragraph{Java} ~to~język paradygmatu obiektowego, bardzo popularny w~systemach bankowych.
