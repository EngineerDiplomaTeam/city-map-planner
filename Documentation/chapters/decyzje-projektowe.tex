...
\indent .NET ~to~jeden z~języków z~rodziny .NET, który mielimy szanse poznać~na~uczelni.
...
\paragraph*{Oprogramowanie~on~premise możemy podzielić~na~bare metal i~virtual.} 
...
\subsubsection{\textnormal{Przegląd rynku}}
