...
\indent  W ramach pracy dyplomowej, której celem było stworzenie aplikacji internetowej, jednym z kluczowych aspektów było zapewnienie jej dostępności 
...
\begin{testowanie}[label={tab:requirements:testnowy2},caption={Scenariusz testowy: Zarzadzania POI z wykorzystaniem ChatGPT}]
    ...
    \resultX{ Godziny wszystkich atrakcji załadowały się poprawnie}
\end{testowanie}
