...
\begin{lstlisting}[H, label={lst:n1}]
server {
...
\begin{lstlisting}[H, label={lst:n2}]
...
\begin{lstlisting}[H, label={lst:n3}]
  gzip on;
  gzip_static on;
  gzip_types
    text/plain
...
\begin{lstlisting}[H, label={lst:n4}]
  location ~*.(css|js)$ {
...
\begin{lstlisting}[H, label={lst:n5}]
  location /Api {
    rewrite /Api/(.*) /$1 break;
...
\begin{lstlisting}[H, label={lst:n6}]
  location ~* /thesis/(.*)$ {
...
\begin{lstlisting}[H, label={lst:n7}]
  location / {
...
\begin{lstlisting}[H, label={lst:n8}]
server {
...
\begin{lstlisting}[H, label={lst:n9}]
server {
...
\begin{lstlisting}[H, label={lst:n10}]
server {
...
\begin{lstlisting}[H, label={lst:n11}]
...
\begin{lstlisting}[H, style=shell-colored,label={lst:db1}]
...
\begin{lstlisting}[H, style=shell-colored,label={lst:db2}]
...
\begin{lstlisting}[H, style=shell-colored,label={lst:db3}]
...
\begin{lstlisting}[H, style=shell-colored,label={lst:db4}]
...
\begin{lstlisting}[H, style=shell-colored,label={lst:db5}]
...
\begin{lstlisting}[H, style=shell-colored,label={lst:db6}]
+echo+ "Backend deployment done"
\end{lstlisting}

\subsubsection{Całość kodu}
\begin{lstlisting}[H, style=shell-colored,label={lst:db7}]
#!/bin/bash
