...
\begin{longlisting}[style=nginx,label={lst:n1}]
server {
...
\begin{longlisting}[style=nginx,label={lst:n2}]
...
\begin{longlisting}[style=nginx,label={lst:n3}]
  gzip on;
  gzip_static on;
  gzip_types
    text/plain
...
\begin{longlisting}[style=nginx,label={lst:n4}]
  location ~*.(css|js)$ {
...
\begin{longlisting}[style=nginx,label={lst:n5}]
  location /Api {
    rewrite /Api/(.*) /$1 break;
...
\begin{longlisting}[style=nginx,label={lst:n6}]
  location ~* /thesis/(.*)$ {
...
\begin{longlisting}[style=nginx,label={lst:n7}]
  location / {
...
\begin{longlisting}[style=nginx,label={lst:n8}]
server {
...
\begin{longlisting}[style=nginx,label={lst:n9}]
server {
...
\begin{longlisting}[style=nginx,label={lst:n10}]
server {
...
\begin{longlisting}[style=nginx,label={lst:n11}]
