...
Kolejnym problematycznym obszarem jest dostęp~do~informacji~o~godzinach otwarcia~i~aktualność tych danych, które często~są~powielone~w~różnych wersjach~w~wielu miejscach.
...
\begin{figure}[h]
    ...
    \caption{Wzbogacony wizerunek planera miejskiego}
...
Zrealizowane zgodnie~z~modelem Rapid Application Development (RAD) ~\cite{sdlm}, który umożliwia szybkie tworzenie aplikacji poprzez iteracyjne~i~przyrostowe podejście~do~wytwarzania oprogramowania.
