...
\begin{requirementstab}[label={tab:requirements:func13},caption={Karta wymagania: Podgląd Wygenerowanej optymalnej trasy }]
    ...
    \sholder{ UOB1, UOB2, UOB3   }
    \reqrelated{F09,FO10,FO11,FO12,FO14, FO15, FO16}
\end{requirementstab}
...
\begin{requirementstab}[label={tab:requirements:func19},caption={Karta wymagania: Widok wybranych atrakcji}]
    ...
    \preconditions{  }
    \postconditions{  }
    \exceptions{ Użytkownik przeciągnął atrakcje na okres czasowych, w którym ona jest niedostępna}
    \implementation{ Dodanie widoku dla użytkownika, którym będzie mógł zobaczyć dodane atrakcję do koszyka. Atrakcje można przeciągać po kalendarzu (wcześniej) 
    }
    \sholder{ UOB2 }
    \reqrelated{F09}
\end{requirementstab}
