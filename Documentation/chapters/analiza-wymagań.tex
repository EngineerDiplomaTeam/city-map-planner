...
\begin{requirementstab}[label={tab:requirements:func6},caption={Karta wymagania: Oceny użytkowników }]
    ...
    \descr{\begin{itemize}
        \item Jako użytkownik 
        \item chce mieć możliwość oceniania atrakcjami gwiazdkami w skali od jeden do pięciu,
...
\begin{requirementstab}[label={tab:requirements:func7},caption={Karta wymagania: Zdjęcia użytkowników + tekst}]
    ...
    \descr{\begin{itemize}
        \item Jako użytkownik 
        \item chce możliwość pisania pisemnych opinii z możliwością dodania zdjęcia,
...
\begin{requirementstab}[label={tab:requirements:func15},caption={Karta wymagania: \glslink{poidef}{POI} użytkowników }]
    ...
    \descr{\begin{itemize}
        \item Jako użytkownik 
        \item chce mieć możliwość dodania nowych punktów i usunięcia z aktualnej listy dostępnych punków,
...
\begin{requirementstab}[label={tab:requirements:func16},caption={Karta wymagania: Środek transportu rower}]
    ...
    \descr{\begin{itemize}
        \item Jako użytkownik 
        \item chce możliwość  wyznaczenia trasy z wykorzystanie roweru np. \glslink{mevo}{mevo}, 
        \item ponieważ chciałbym korzystać ze swojego roweru bądź wypożyczonego podczas zwiedzania. 
    \end{itemize}
    }
...
\begin{requirementstab}[label={tab:requirements:func20},caption={Karta wymagania: Algorytm Plannera}]
    ...
    \descr{\begin{itemize}
        ...
        \item ponieważ umożliwi to interaktywne korzystanie cały czas bez dłuższego nakładu czasowego. 
    \end{itemize}
    }
...
\begin{requirementstab}[label={tab:requirements:func23},caption={Karta wymagania: Przeliczanie Trasy o opóźnienia komunikacji}]
    ...
    \descr{\begin{itemize}
        ...
        \item ponieważ chciałbym posiadać aktualne dane ile będę czekać
    \end{itemize}
    }
...
\begin{requirementstab}[label={tab:requirements:func26},caption={Karta wymagania: Widok list atrakcji}]
    ...
    \reqrelated{F09}
\end{requirementstab}
\begin{requirementstab}[label={tab:requirements:func27},caption={Karta wymagania: Widok wybranych atrakcji}]
    \id{F27}
    \priority{S}
    \name{Widok kalendarza planowania podróży}
    \descr{Widok kalendarza przedstawia wybrane atrakcje przez użytkownika.
    Użytkownik może wybrać zakres przedziału czasowego, jaki ma odwiedzanie atrakcji.
    Kalendarz umożliwia wybór  przedziałów czasowych, oraz ustalenie możliwości odwiedzin dla danej atrakcji według dostępności czasowych tej atrakcji.
    }
    \acceptcrit{  }
    \inputdata{ Dodane atrakcje do koszyka}
    \preconditions{  }
    \postconditions{  }
    \exceptions{ Użytkownik przeciągnął atrakcje na okres czasowych, w którym ona jest nie dostępna}
    \implementation{ Dodanie widoku dla użytkownika, którym będzie mógł zobaczyć dodane atrakcję do koszyka. Atrakcje można przeciągać po kalendzarzu ( wcześniej ) 
