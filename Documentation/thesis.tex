...
\date{\today}
\nabstract{
	Planując zwiedzanie miasta, którego nie znamy, musimy wykonać wiele manualnych czynności,
	takich jak wybór punktów zainteresowania, sprawdzenie godzin otwarcia,
	sposobu dojazdu i finalnie ułożenie planu zwiedzania w optymalny sposób.

	Co więcej, gdy zajdzie nagła potrzeba zmiany ułożonego planu, musimy te czynności powtórzyć.
