...
\projectgoals{Stworzenie interaktywnej mapy miejskiej do planowania zwiedzania atrakcji turystycznych z wykorzystaniem dynamicznych danych.}
...
\successmeasure{Realizacja w terminie.}
\projlimitation{Ograniczony budżet.}
\projlimitation{Zgodność projektu z wymaganiami.}
\date{\today}
\nabstract{
